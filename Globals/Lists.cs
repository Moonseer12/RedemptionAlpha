...
namespace Redemption.Globals
{
    public static class TileLists
    {
        ...
        public static List<int> AncientWallArray = new()
        {
            WallType<GathicFroststoneBrickWallTile>(), WallType<GathicFroststoneBrickWallTileUnsafe>(), WallType<GathicFroststoneWallTile>(), WallType<GathicFroststoneWallTileUnsafe>(), WallType<GathicGladestoneBrickWallTile>(), WallType<GathicGladestoneBrickWallTileSafe>(), WallType<GathicGladestoneWallTile>(), WallType<GathicGladestoneWallTileSafe>(), WallType<GathicStoneBrickWallTile>(), WallType<GathicStoneBrickWallTileSafe>(), WallType<GathicStoneWallTile>(), WallType<GathicStoneWallTileSafe>()
        };
    ...
    public static class NPCLists
    {
        ...
        public static List<int> Plantlike = new() { NPCID.FungiBulb, NPCID.AnomuraFungus, NPCID.MushiLadybug, NPCID.ManEater, NPCID.Snatcher, NPCID.AngryTrapper, NPCID.FungoFish, NPCID.GiantFungiBulb, NPCID.HoppinJack, NPCID.Dandelion, NPCID.Plantera, NPCID.MourningWood, NPCID.Splinterling, NPCID.Pumpking, NPCID.Everscream, NPCID.PlanterasTentacle, NPCID.Scarecrow1, NPCID.Scarecrow2, NPCID.Scarecrow3, NPCID.Scarecrow4, NPCID.Scarecrow5, NPCID.Scarecrow6, NPCID.Scarecrow7, NPCID.Scarecrow8, NPCID.Scarecrow9, NPCID.Scarecrow10, ModContent.NPCType<LivingBloom>(), ModContent.NPCType<DevilsTongue>(), ModContent.NPCType<Thorn>(), ModContent.NPCType<TreebarkDryad>(), ModContent.NPCType<MutatedLivingBloom>(), ModContent.NPCType<ForestNymph>(), ModContent.NPCType<Akka>(), ModContent.NPCType<ForestNymph_Friendly>(), ModContent.NPCType<ForestNymph_SS>() };
    ...
    public static class ItemLists
    {
        ...
        { ItemID.BreathingReed, ItemID.ZombieArm, ItemID.PurpleClubberfish, ItemID.TaxCollectorsStickOfDoom, ItemID.SlapHand, ItemID.Keybrand, ItemID.HamBat, ItemID.BatBat, ItemID.StaffofRegrowth, ItemID.WaffleIron, ItemID.TentacleSpike };

        public static List<int> NoElement = new()
        { ItemID.BlueSolution, ItemID.DarkBlueSolution, ItemID.GreenSolution, ItemID.PurpleSolution, ItemID.RedSolution, ItemID.RocketI, ItemID.RocketII, ItemID.RocketIII, ItemID.RocketIV, ItemID.DirtSolution, ModContent.ItemType<BleachedSolution>() };
