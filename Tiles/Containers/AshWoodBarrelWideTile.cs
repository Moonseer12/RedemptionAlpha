...
{
    public class AshWoodBarrelWideTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(126, 105, 108), name, MapChestName);
        ...
        public override bool CanKillTile(int i, int j, ref bool blockDamaged)
        {
            ...
            if (Framing.GetTileSafely(left, top - 1).TileType == Type || Framing.GetTileSafely(left + 1, top - 1).TileType == Type)
                return false;
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ItemType<AshWoodBarrelWide>();
