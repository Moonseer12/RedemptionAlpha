...
{
    public class DemonTailorTentTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(119, 82, 132), name);
        }
    ...
    public class DemonTailorTent : PlaceholderTile
    {
        public override string Texture => "Redemption/Tiles/Placeholder/DemonTailorTent";
        public override void SetDefaults()
        {
            base.SetDefaults();
            Item.createTile = TileType<DemonTailorTentTile>();
        }
    }
}