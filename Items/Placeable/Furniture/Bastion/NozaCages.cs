...
namespace Redemption.Items.Placeable.Furniture.Bastion
{
    public class NozaCageSmall : ModItem
    {
        ...
        {
            Item.DefaultToPlaceableTile(TileType<NozaCageSmallTile>(), 0);
            Item.width = 32;
            Item.height = 32;
    ...
    public class NozaCage : ModItem
    {
        ...
        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(TileType<NozaCageTile>(), 0);
            Item.width = 32;
            Item.height = 32;
            Item.maxStack = Item.CommonMaxStack;
            Item.rare = ItemRarityID.Blue;
    ...
    public class NozaCageLarge : ModItem
    {
        ...
        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(TileType<NozaCageLargeTile>(), 0);
            Item.width = 32;
            Item.height = 32;
            Item.maxStack = Item.CommonMaxStack;
            Item.rare = ItemRarityID.Blue;
