...
namespace Redemption.Items.Weapons.PostML.Ranged
{
    public class Electronade_Proj : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, Vector2.Zero, ProjectileType<Electronade_TeslaField>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
        }
    ...
    public class Electronade_TeslaField : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                DustHelper.DrawParticleElectricity(Projectile.Center, Projectile.Center + RedeHelper.PolarVector(90, RedeHelper.RandomRotation()), 1, 20, 0.1f);
                DustHelper.DrawParticleElectricity(Projectile.Center, Projectile.Center + RedeHelper.PolarVector(90, RedeHelper.RandomRotation()), 1, 20, 0.1f);
            }
