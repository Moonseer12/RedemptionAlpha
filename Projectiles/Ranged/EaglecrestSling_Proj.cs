...
namespace Redemption.Projectiles.Ranged
{
    public class EaglecrestSling_Proj : ModProjectile, ITrailProjectile
    {
        ...
        {
            tManager.CreateTrail(Projectile, new GradientTrail(new Color(135, 122, 119), new Color(41, 36, 35)), new RoundCap(), new DefaultTrailPosition(), 50f, 100f, new ImageShader(CommonTextures.Trail_4.Value, 0.1f, 1f, 1f));
        }
