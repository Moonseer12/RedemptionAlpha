...
namespace Redemption.NPCs.Friendly.SpiritSummons
{
    public class SkeletonDuelist_SS : SkeletonBase
    {
        ...
        public override void AI()
        {
            ...
            switch (AIState)
            {
                ...
                case ActionState.Alert:
                    ...
                    NPCHelper.HorizontallyMove(NPC, attacker.Center, 0.2f, 2.2f * SpeedMultiplier * (NPC.RedemptionNPCBuff().rallied ? 1.2f : 1),
                ...
                case ActionState.Attack:
                    ...
                    if (AniFrameY is 3 or 6)
                        NPC.RedemptionHitbox().DamageInHitbox(NPC, 2, AniFrameY == 3 ? SlashHitbox1 : SlashHitbox2, NPC.damage, 6f, false, 10);
                    break;
        ...
        {
            RedeHelper.SpawnNPC(NPC.GetSource_FromAI(), (int)NPC.Center.X, (int)NPC.Center.Y, NPCType<LostSoulNPC>(), Main.rand.NextFloat(0.2f, 0.6f));
        }
    }
}